...
const MatchDetail = ({secondUserId, scoreArtist, scoreGenre, scoreTrack, scoreAverage, User, MatchTracks, MatchArtists, updatedAt}: MatchData) => {
    return (
        <div className="w-1/3 h-full bg-white rounded-xl drop-shadow-md px-10 py-10 space-y-6 flex flex-col items-center overflow-y-scroll" key={secondUserId}>
